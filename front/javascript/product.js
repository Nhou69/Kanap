...
function addToCart() {
  ...
  addToCartButton.addEventListener("click", function () {
    ...
    const foundProduct = productsInLocalStorage.find(
      (element) => element._id === selectedProduct._id
    );
    const foundColor = productsInLocalStorage.find(
      (colorValue) => colorValue.colors === selectedProduct.colors
    );
